...
_MRF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='HelpText', full_name='googlemrf.MRF.HelpText', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='IndicatedStatus', full_name='googlemrf.MRF.IndicatedStatus', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='MMG', full_name='googlemrf.MRF.MMG', index=18,
...
_MRFLIST = _descriptor.Descriptor(
  name='MRFList',
  full_name='googlemrf.MRFList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='Mrfs', full_name='googlemrf.MRFList.Mrfs', index=0,
...
DESCRIPTOR.message_types_by_name['MRFList'] = _MRFLIST
...
MRFList = _reflection.GeneratedProtocolMessageType('MRFList', (_message.Message,), dict(
  DESCRIPTOR = _MRFLIST,
  __module__ = 'google_mrf_pb2'
  # @@protoc_insertion_point(class_scope:googlemrf.MRFList)
  ))
_sym_db.RegisterMessage(MRFList)
...
_GOOGLEMRF = _descriptor.ServiceDescriptor(
  name='GoogleMRF',
  full_name='googlemrf.GoogleMRF',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='MRFInfo',
    full_name='googlemrf.GoogleMRF.MRFInfo',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='MRFs',
    full_name='googlemrf.GoogleMRF.MRFs',
    index=1,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_MRF,
  ...
  _descriptor.MethodDescriptor(
    name='Agencies',
    full_name='googlemrf.GoogleMRF.Agencies',
    index=2,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_SINGLE,
  ...
  _descriptor.MethodDescriptor(
    name='LOBs',
    full_name='googlemrf.GoogleMRF.LOBs',
    index=3,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_SINGLE,
  ...
  _descriptor.MethodDescriptor(
    name='Products',
    full_name='googlemrf.GoogleMRF.Products',
    index=4,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_DOUBLE,
  ...
  _descriptor.MethodDescriptor(
    name='SubProducts',
    full_name='googlemrf.GoogleMRF.SubProducts',
    index=5,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_DOUBLE,
  ...
  _descriptor.MethodDescriptor(
    name='Channels',
    full_name='googlemrf.GoogleMRF.Channels',
    index=6,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_SINGLE,
  ...
  _descriptor.MethodDescriptor(
    name='Medias',
    full_name='googlemrf.GoogleMRF.Medias',
    index=7,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_DOUBLE,
  ...
  _descriptor.MethodDescriptor(
    name='SubMedias',
    full_name='googlemrf.GoogleMRF.SubMedias',
    index=8,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_DOUBLE,
  ...
  _descriptor.MethodDescriptor(
    name='ValidateMRF',
    full_name='googlemrf.GoogleMRF.ValidateMRF',
    index=9,
    containing_service=None,
    input_type=_QUERY,
    output_type=_MRF,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\025\022\023/api/v1/mrfs/{name}')),
  ),
  _descriptor.MethodDescriptor(
    name='ValidateAgency',
    full_name='googlemrf.GoogleMRF.ValidateAgency',
    index=10,
    containing_service=None,
    input_type=_QUERY,
    output_type=_SINGLE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\031\022\027/api/v1/agencies/{name}')),
  ),
  _descriptor.MethodDescriptor(
    name='ValidateChannel',
    full_name='googlemrf.GoogleMRF.ValidateChannel',
    index=11,
    containing_service=None,
    input_type=_QUERY,
    output_type=_SINGLE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\031\022\027/api/v1/channels/{name}')),
  ),
  _descriptor.MethodDescriptor(
    name='ValidateLOB',
    full_name='googlemrf.GoogleMRF.ValidateLOB',
    index=12,
    containing_service=None,
    input_type=_QUERY,
    output_type=_SINGLE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\025\022\023/api/v1/lobs/{name}')),
  ),
  _descriptor.MethodDescriptor(
    name='ValidateMedia',
    full_name='googlemrf.GoogleMRF.ValidateMedia',
    index=13,
    containing_service=None,
    input_type=_QUERY,
    output_type=_SINGLE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\027\022\025/api/v1/medias/{name}')),
  ),
  _descriptor.MethodDescriptor(
    name='ValidateProduct',
    full_name='googlemrf.GoogleMRF.ValidateProduct',
    index=14,
    containing_service=None,
    input_type=_QUERY,
    output_type=_SINGLE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\031\022\027/api/v1/products/{name}')),
  ),
  _descriptor.MethodDescriptor(
    name='ValidateSubMedia',
    full_name='googlemrf.GoogleMRF.ValidateSubMedia',
    index=15,
    containing_service=None,
    input_type=_QUERY,
    output_type=_SINGLE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\032\022\030/api/v1/submedias/{name}')),
  ),
  _descriptor.MethodDescriptor(
    name='ValidateSubProduct',
    full_name='googlemrf.GoogleMRF.ValidateSubProduct',
    index=16,
    containing_service=None,
    input_type=_QUERY,
    output_type=_SINGLE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\034\022\032/api/v1/subproducts/{name}')),
  ),
  _descriptor.MethodDescriptor(
    name='LongTailMRFs',
    full_name='googlemrf.GoogleMRF.LongTailMRFs',
    index=17,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_MRFLIST,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\023\022\021/api/v1/longtails')),
  ),
])
_sym_db.RegisterServiceDescriptor(_GOOGLEMRF)

DESCRIPTOR.services_by_name['GoogleMRF'] = _GOOGLEMRF
...
try:
  ...
  class GoogleMRFStub(object):
    ...
    def __init__(self, channel):
      ...
      self.LongTailMRFs = channel.unary_unary(
          ...
          request_serializer=Empty.SerializeToString,
          response_deserializer=MRFList.FromString,
          )
  ...
  def add_GoogleMRFServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'LongTailMRFs': grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=Empty.FromString,
            response_serializer=MRFList.SerializeToString,
        ),
    }
  ...
  class BetaGoogleMRFStub(object):
    ...
    def LongTailMRFs(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      """All 'long tail' mrfs.
      """
      raise NotImplementedError()
    LongTailMRFs.future = None
  ...
  def beta_create_GoogleMRF_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ...
      ('googlemrf.GoogleMRF', 'LongTailMRFs'): Empty.FromString,
    ...
    response_serializers = {
      ...
      ('googlemrf.GoogleMRF', 'LongTailMRFs'): MRFList.SerializeToString,
    ...
    method_implementations = {
      ...
      ('googlemrf.GoogleMRF', 'LongTailMRFs'): face_utilities.unary_unary_inline(servicer.LongTailMRFs),
  ...
  def beta_create_GoogleMRF_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    request_serializers = {
      ...
      ('googlemrf.GoogleMRF', 'LongTailMRFs'): Empty.SerializeToString,
    ...
    response_deserializers = {
      ...
      ('googlemrf.GoogleMRF', 'LongTailMRFs'): MRFList.FromString,
    ...
    cardinalities = {
      ...
      'LongTailMRFs': cardinality.Cardinality.UNARY_UNARY,
